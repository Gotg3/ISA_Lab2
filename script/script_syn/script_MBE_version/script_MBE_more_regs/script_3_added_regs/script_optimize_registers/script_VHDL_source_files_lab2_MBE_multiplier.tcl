...
analyze -f vhdl -lib work ../src/fpmul_stage2_struct_3_added_regs_MBE.vhd
...
elaborate FPmul -arch pipeline -lib WORK > ./elaborate_MBE_multiplier_3_regs_optimize_registers.txt
