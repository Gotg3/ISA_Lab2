...
analyze -f vhdl -lib work ../src/fpmul_stage2_struct_4_added_regs_MBE.vhd
...
elaborate FPmul -arch pipeline -lib WORK > ./elaborate_MBE_multiplier_4_regs_optimize_registers.txt
