...
analyze -f vhdl -lib work ../src/BEU_pp17.vhd
...
analyze -f vhdl -lib work ../src/fpmul_stage2_struct_regs_MBE.vhd
...
elaborate FPmul -arch pipeline -lib WORK > ./elaborate_MBE_multiplier_optimize_registers.txt
