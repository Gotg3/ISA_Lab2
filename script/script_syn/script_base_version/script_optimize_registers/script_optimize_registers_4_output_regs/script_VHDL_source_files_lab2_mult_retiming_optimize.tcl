...
analyze -f vhdl -lib work ../src/fpmul_stage2_struct_4_added_regs.vhd
...
elaborate FPmul -arch pipeline -lib WORK > ./elaborate_mult_4_added_regs_retiming_optimize.txt
