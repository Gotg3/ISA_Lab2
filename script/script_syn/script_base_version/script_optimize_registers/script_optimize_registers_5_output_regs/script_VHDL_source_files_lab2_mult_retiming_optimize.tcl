...
analyze -f vhdl -lib work ../src/fpmul_stage2_struct_5_added_regs.vhd
...
elaborate FPmul -arch pipeline -lib WORK > ./elaborate_mult_5_added_regs_retiming_optimize.txt
